  ...
  async createClass(dto: CreateClassDto, user?: RequestUser): Promise<unknown> {
    ...
    return this.prisma.class.create({
      data: {
        ...
        combinationCode: dto.combinationCode?.trim().toUpperCase() || null,
        combinationId: dto.combinationId || null,
  ...
  async updateClass(id: string, dto: Partial<CreateClassDto>): Promise<unknown> {
    ...
    return this.prisma.class.update({
      ...
      data: {
        ...
        curriculumCode: dto.curriculumCode,
        combinationCode: dto.combinationCode === undefined ? undefined : (dto.combinationCode?.trim().toUpperCase() || null),
        combinationId: dto.combinationId === undefined ? undefined : (dto.combinationId || null),
