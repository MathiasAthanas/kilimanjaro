...
class MockStudentDataService implements IStudentService {
  ...
  static final _reportCards = <ReportCardModel>[
    ReportCardModel(
      ...
      reportTemplateCode: 'O_LEVEL_TERM',
      divisionSummary: 'O-Level term report with division-track monitoring. Science intervention flagged.',
      overallScore: 79.3,
      overallGrade: 'B',
      rank: 6,
      totalStudents: 42,
    ...
    ReportCardModel(
      ...
      educationStage: 'O_LEVEL',
      reportTemplateCode: 'O_LEVEL_TERM',
      divisionSummary: 'O-Level continuous assessment summary.',
      overallScore: 74.5,
      overallGrade: 'B-',
      rank: 8,
      totalStudents: 40,
    ...
    ReportCardModel(
      ...
      educationStage: 'O_LEVEL',
      reportTemplateCode: 'O_LEVEL_TERM',
      divisionSummary: 'O-Level baseline term summary with science-risk note.',
      overallScore: 70.6,
      overallGrade: 'B-',
      rank: 10,
      totalStudents: 40,
